        ...
        <div className=" relative flex flex-col  items-center justify-center">
            <div className="w-full h-2 bg-black"></div>
             <div className="h-screen pt-36">
                ...
                {/* TEXT GRID */}
             <div className="grid grid-cols-1 md:grid-cols-2 grid-rows-3  gap-12 p-4 w-full px-16  mt-24">
                ...
                <div className="text-4xl font-extralight    mt-24 flex justify-center items-start pr-12  hover:text-zinc-900">
                ...
                <div className=" text-2xl uppercase  flex justify-center items-start hover:text-zinc-900">
