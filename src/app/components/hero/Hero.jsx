            ...
            <div className="relative flex-grow w-full flex flex-col items-center justify-center " >
                ...
                <div className=" relative flex flex-col gap-6 items-center justify-start">
                    ...
                    <div className=" flex w-full justify-start items-center gap-12 md:px-2">
                        ...
                        <motion.span initial="hidden" animate="visible" transition={{staggerChildren: 0.1}} className="text-5xl md:text-6xl lg:text-7xl xl:text-8xl  font-light">{heading1.split('').map((char, i) => (<motion.span key={i} variants={headerAnimation}>{char}</motion.span>))}</motion.span>
                        {/* <motion.svg className="h-6 w-6 md:w-12 md:h-12" viewBox="0 0 51 54" fill="red" xmlns="http://www.w3.org/2000/svg" variants={svgVariants} initial="hidden"  whileHover='hover' >
                    ...
                    <div className="flex w-full justify-start items-center gap-4 ">
                        {/* <motion.svg variants={svgVariants} initial='hidden'  viewBox="0 0 430 430" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-8 h-8  md:w-16 md:h-16">
                        ...
                        <motion.span initial="hidden" animate="visible" transition={{staggerChildren: 0.1, delayChildren: 1 }} className="text-6xl md:text-7xl lg:text-8xl xl:text-9xl font-bold">{heading2.split('').map((char, i) => (<motion.span key={i} variants={headerAnimation}>{char}</motion.span>))}</motion.span>
                    </div>
                </div>
            </div>
            
            {/* BOTTOM TEXT */}
            <div className="relative font-mono text-xl h-12 overflow-hidden flex items-center"> 
